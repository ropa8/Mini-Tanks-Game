...
Bullet(double XPosition, double YPosition, double height, double width, double speed){
...
Barrel(double XPosition, double YPosition, double barrelLength, double angle, double bullet){
	this-> XPosition = XPosition;
	this-> YPosition = YPosition;
...
Tank(double XPosition, double YPosition, double height, double width, int numberOfRemainingBullets, int numberOfCorrectShoots, int numberOfRemainingChances){
	this-> XPosition = XPosition;
	this-> YPosition = YPosition;
	this-> height = height;
	this-> width = width;
